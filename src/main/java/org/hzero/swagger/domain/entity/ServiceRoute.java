...
public class ServiceRoute extends AuditDomain {
    ...
    @ApiModelProperty(value = "产品环境ID")
    private Long productEnvId;
    ...
    @ApiModelProperty(value = "是否支持路由重试")
    ...
    public void defaultProduct() {
        this.productId = Governance.DEFAULT_ID;
        this.productEnvId = Governance.DEFAULT_ID;
    }
     ...
     * @return 产品环境ID
     */
    public Long getProductEnvId() {
        return productEnvId;
    }

    public void setProductEnvId(Long productEnvId) {
        this.productEnvId = productEnvId;
    }
